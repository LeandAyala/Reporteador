 ...
 */
final class Version20251113230955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        "
            ...
            BEGIN
                IF 
                    NOT EXISTS(SELECT * FROM central.reportes WHERE modulo = 'Consumo' AND nombre = 'Test 4' AND estado = 1)
                THEN 
