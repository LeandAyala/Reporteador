 ...
 */
final class Version20251118134542 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Se crea el informe Informe Cardex en el módulo de Consumo';
    }
    ...
    public function up(Schema $schema): void
    {
        $sql = 
        "
            select fecha,tipo_movimiento, comprobante,numero, tercero,detalle, 
