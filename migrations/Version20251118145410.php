 ...
 */
final class Version20251118145410 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Se crea el informe Informe Cardex Consumo en el módulo de Consumo';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        "
            ...
            BEGIN
                IF 
                    NOT EXISTS(SELECT * FROM central.reportes WHERE modulo = 'Consumo' AND nombre = 'Informe Cardex Consumo' AND estado = 1)
                THEN 
                    INSERT INTO central.reportes(id,tipo,modulo,nombre,ruta,sql,json,estado,migracion) 
                    VALUES (NEXTVAL('central.reportes_id_seq'), 1, 'Consumo', 'Informe Cardex Consumo', '', 'select fecha,tipo_movimiento, comprobante,numero, tercero,detalle, 
