...
class FacturaController extends AbstractController
{
    ...
    public function listarFactura()
    {
        ...
        */
        ...
        return $this->render('Facturas\listaFactura.html.twig',
        [
            'formFiltros' => $formFiltros->createView()
        ]);
    }

    public function frameListaFactura(Request $request)
    {
        /**
        ...
        */
        ...
        $listRegistros = $bd->getRepository(Factura::class)->findFactura($filtrosBusqueda);
        return $this->render('Facturas\frameListaFactura.html.twig',
        [
            'listRegistros' => $listRegistros
        ]);
    }

    public function frameNuevoFactura(Request $request)
    {
        /** 
        ...
        */
        ...
        $formularioPrincipal = $this->createForm(NuevoFacturaType::class, $registro, ['id' => $id]);
        return $this->render('Facturas\frameNuevoFactura.html.twig', 
        [
    ...
    public function guardarFactura(Request $request)
    {
        ...
        */
        ...
        $registro = !empty($form['idRegistro'])?$bd->getRepository(Factura::class)->find($form['idRegistro']):new Factura();
        $formularioPrincipal = $this->createForm(NuevoFacturaType::class, $registro, ['id' => 0]);
